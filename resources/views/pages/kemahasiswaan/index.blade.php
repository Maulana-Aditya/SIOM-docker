    ...
    <a href="{{ route('proposal.viewPdf', ['id' => $proposal->id]) }}"
       ...
       >
        <i class="fas fa-file-pdf me-1"></i> View PDF
                            ...
                            <td>
                                <form action="{{ route('kemahasiswaan.proposal.acc', $proposal->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                ...
                                <div class="modal-content">
                                    <form action="{{ route('kemahasiswaan.proposal.revisi', $proposal->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="file_revisi{{ $proposal->id }}" class="form-label">Upload File Revisi (Opsional)</label>
