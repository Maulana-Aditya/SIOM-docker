        ...
        <i class="fas fa-file-pdf me-1"></i> View PDF
                                    ...
                                    <td>
                                        @if ($proposal->file_revisi)
                                            <a href="{{ asset($proposal->file_revisi) }}" class="btn btn-warning btn-sm text-nowrap" target="_blank" download>
                                                Download Revisi
                                            </a>
                                        @else
                                            ...
                                            <form action="{{ route('proposal.revisi.admin', $proposal->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="file" name="file_revisi" id="fileRevisi{{ $proposal->id }}" class="form-control" accept=".docx,.pdf">
                                                    </div>
                                                </div>
